        ...
        *,
        ...
        try:
            ...
            system_prompt = (
                ...
                "кто инициатор, что именно сделать, зачем/для кого, и любые упомянутые "
                "детали (имена, документы, суммы, сроки). Бери информацию ИЗ КОНТЕКСТА "
                "ЧАТА, не только из текущего сообщения. Если контекст помогает уточнить "
