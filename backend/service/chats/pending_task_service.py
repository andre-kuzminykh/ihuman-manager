...
class PendingTaskService:
    ...
    async def create(
        ...
        *,
        ...
        return await self._repo.create(
            ...
            source_sender_user_id=source_sender_user_id,
    ...
    async def approve(
        ...
        task, _is_duplicate = await self._task_service.create_or_find_duplicate(
            ...
            source_sender_user_id=obj.source_sender_user_id,
            source_sender_username=obj.source_sender,
            source_sender_display=obj.source_sender_display,
            source_chat_username=obj.source_chat_username,
