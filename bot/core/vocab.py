...
START = (
    "Привет! Я iHuman Manager — помогаю вести задачи.\n\n"
    "📝 Отправляй мне задачи <b>текстом</b> или <b>голосом</b> — я их распознаю, "
    "разберу на отдельные задачи (если их несколько), уберу дубли и буду трекать.\n\n"
    "Это работает везде, где я подключён:\n"
    "• в DM со мной;\n"
    "• в групповых чатах, куда меня добавили;\n"
    "• в твоих DM-чатах, если ты подключил Telegram Business → Chatbots.\n\n"
    "<b>Команды:</b>\n"
